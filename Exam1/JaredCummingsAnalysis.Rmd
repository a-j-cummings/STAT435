...
The code for this analysis can be found [here](https://github.com/a-j-cummings/STAT435/blob/0679e7ebd4a932317594e19672776701c7404d8f/Exam1/JaredCummingsAnalysis.R) and is supplemented by code for the resampling tests, which can be found [here](https://github.com/a-j-cummings/STAT435/blob/5430cd29c6ffa3405216394c8e75aff33280f58b/Exam1/resampling_tests.R).
